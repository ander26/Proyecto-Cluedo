...
public class ventanaccodenadacirculos extends JFrame {
	...
	public ventanaccodenadacirculos(){
		...
		//Point [] arrpuertas={new Point(1391,397),new Point(241,120),new Point(209,255),new Point(504,196),new Point(629,113),new Point(1097,289),new Point(1621,185),new Point(1650,325),new Point(1846,174),new Point(1880,334),new Point(1317,809),new Point(573,876),new Point(855,261)};
		...
		for(int j=0;j<arrpuertas.length;j++){
			...
			b.setSize(200,200);			
			b.setLocation((int)arrpuntmarrones.get(j).getX(),(int)arrpuntmarrones.get(j).getY()-88);
